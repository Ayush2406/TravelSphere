...
{\Huge\bfseries TravelSphere}

\vspace{0.3cm}

{\Large A Community-Driven Travel Ecosystem}

\vspace{0.3cm}

{\large\textit{Plan • Protect • Save • Discover}}
...
\begin{tabular}{ll}
\textbf{Name} & \textbf{Roll Number} \\ \hline
...
Current travel platforms solve only individual aspects of travel, requiring users to constantly switch between applications.
...
User Profiles &
Users can create personalized profiles containing travel interests, visited destinations, and travel history. \\

\hline

Travel Feed &
Share travel experiences, recommendations, photographs, food suggestions, hidden places, and travel tips. \\

\hline

Trip Management &
Create trips, maintain travel journals, and organize travel timelines. \\

\hline

Interactive Map &
Display location-tagged travel posts, nearby attractions, and community updates on an interactive map. \\

\hline

Travel Companion &
Find and connect with travelers visiting similar destinations or planning similar trips. \\

\hline

Safety Alerts &
Report road closures, scams, weather conditions, accidents, and emergency situations to help nearby travelers. \\

\hline

Notifications &
Receive updates from followed travelers, destinations, and important community alerts. \\
